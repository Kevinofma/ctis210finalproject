...
public class secondGame {
    ...
    JFrame frame = new JFrame("The Stains of Time");
...
//    songThread.start();
    ...
    MusicPlayerThread2 songThread = new MusicPlayerThread2();
    ...
    public static double songLength = 125; // change this variable to length of song in seconds
    // public static double songLength = 5; // used for testing how game ends
    public static boolean stop = false;
    public static int score = 0;
    private int startDelay = 8; // set to how many beats u wana skip before notes start spawning
    // private int startDelay = 4; // used for testing game mechanics
    private int delay = MusicPlayerThread2.getDelay();
...
//        missNote.addActionListener(this);
        ...
        ImageIcon check = new ImageIcon(secondGame.class.getResource("/greenCheckMarkRescaled-removebg-preview.png"));
