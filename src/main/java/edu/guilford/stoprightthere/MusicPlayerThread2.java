 ...
 * @author kevin
 */
public class MusicPlayerThread2 extends Thread {
    ...
    public void run() {
        ...
        File file = new File(MusicPlayerThread2.class.getResource("/The_Stains_of_Time.wav").getFile());
        ...
        try {
            ...
            clip.start();
            boolean stop = secondGame.isStop();
            System.out.println("Start Song Now!");
            while(stop == false) {
                stop = secondGame.isStop();
                System.out.print("");
