...
public class firstGame {
    ...
    JFrame frame = new JFrame("Flower Dance");
...
//    songThread.start();
    ...
    MusicPlayerThread songThread = new MusicPlayerThread();

    public static int BPM = 100; // change to corresponding BPM
    ...
    public static double songLength = 260; // change this variable to length of song in seconds
    // public static double songLength = 5; // used for testing how game ends
    public static boolean stop = false;
    public static int score = 0;
    private int startDelay = 44; // set to how many beats u wana skip before notes start spawning
    // private int startDelay = 4; // used for testing game mechanics
    private int delay = MusicPlayerThread.getDelay();
...
//        missNote.addActionListener(this);
        ...
        ImageIcon check = new ImageIcon(firstGame.class.getResource("/greenCheckMarkRescaled-removebg-preview.png"));
    ...
    private void missNoteMousePressed(java.awt.event.MouseEvent evt) {
        // TODO add your handling code here:
            ...
            if (hardcore) {
                //add killsound.wav to play when you miss a note in hardcore mode
                gameEnd();
            }
    }
