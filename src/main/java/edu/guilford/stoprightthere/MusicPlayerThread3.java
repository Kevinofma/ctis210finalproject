 ...
 * @author kevin
 */
public class MusicPlayerThread3 extends Thread {
    ...
    public void run() {
        ...
        File file = new File(MusicPlayerThread3.class.getResource("/Dynamite.wav").getFile());
        ...
        try {
            ...
            clip.start();
            boolean stop = thirdGame.isStop();
            System.out.println("Start Song Now!");
            while(stop == false) {
                stop = thirdGame.isStop();
                System.out.print("");
