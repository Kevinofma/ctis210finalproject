...
public class scoreCard2 {
    ...
    scoreCard2() {
        ...
        scoreLabel.setText("Score: " + secondGame.getScore());
        frame.add(scoreLabel);
        
        earlyLabel.setBounds(25,225,200,40);
        earlyLabel.setText("Early Hits: " + secondGame.getEarlyCount());
        frame.add(earlyLabel);
        
        perfectLabel.setBounds(25, 250, 200, 40);
        perfectLabel.setText("Perfect Hits!: " + secondGame.getPerfectCount());
        frame.add(perfectLabel);
        
        lateLabel.setBounds(25, 275, 200, 40);
        lateLabel.setText("Late Hits: " + secondGame.getLateCount());
        frame.add(lateLabel);
        
        missLabel.setBounds(25, 300, 200, 40);
        missLabel.setText("Missed Hits: " + secondGame.getMissCount());
        frame.add(missLabel);
